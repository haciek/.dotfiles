...
-- local primary_sel           = "#ffbe3c" -- Bright Green
-- local primary_norm          = "#333333" -- Dark Green
...
theme.taglist_squares_sel = theme_assets.taglist_squares_sel(
    taglist_square_size, theme.tasklist_bg_focus
)
theme.taglist_squares_unsel = theme_assets.taglist_squares_unsel(
    taglist_square_size, theme.taglist_squares_unsel
)
...
-- theme.wallpaper = "~/doc/pics/wallpapers/wall.png"
