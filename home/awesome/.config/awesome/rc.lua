...
local tasklist_buttons = gears.table.join(
   ...
   awful.screen.connect_for_each_screen(function(s)
      ...
      s.mywibox:setup {
         ...
         { -- Right widgets
            ...
            awful.widget.watch('bash -c "volume.sh"', 1),
            -- wibox.widget.textbox('|'),
   ...
   local function layout_kbd(is_dvorak)
      ...
      if (is_dvorak == true) then
         globalkeys = gears.table.join(
            awful.key({ modkey, "Shift"   }, "a",      hotkeys_popup.show_help,
   ...
   awful.rules.rules = {
      ...
      { rule_any = { name = {"discord", "Discord" } },
      properties = { screen = 2, tag = "2" } },
      { rule_any = { name = { "Spotify", "spotify"} },
      properties = { screen = 2, tag = "3" } },
      { rule_any = { name = {"Steam", "steam"} },
